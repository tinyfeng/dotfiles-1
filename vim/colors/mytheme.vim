" Vim color file - test
" Generated by http://bytefluent.com/vivify 2017-11-27
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Normal guifg=#e6e5ff guibg=#000000 guisp=#000000 gui=bold ctermfg=189 ctermbg=NONE cterm=bold
...
hi Comment guifg=#7d88ff guibg=NONE guisp=NONE gui=NONE ctermfg=12 ctermbg=NONE cterm=NONE
...
hi Function guifg=#ff4252 guibg=NONE guisp=NONE gui=bold,italic ctermfg=13 ctermbg=NONE cterm=bold
hi FoldColumn guifg=#8b8bcd guibg=#2e2e2e guisp=#2e2e2e gui=NONE ctermfg=104 ctermbg=236 cterm=NONE
hi PreProc guifg=#aeff78 guibg=NONE guisp=NONE gui=italic ctermfg=156 ctermbg=NONE cterm=NONE
...
hi Type guifg=#fa0000 guibg=NONE guisp=NONE gui=NONE ctermfg=196 ctermbg=NONE cterm=NONE
